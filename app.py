...
def build_model(df):
    ...
    def main():
        ...
        ads_effective = float(st.text_input('ads_effective'))
        fam_new = float(st.text_input('fam_new'))
        gen_new = float(st.text_input('gen_new'))
        rate_new = float(st.text_input('rate_new'))
        buy_new = float(st.text_input('buy_new'))
        price_new = float(st.text_input('price_new'))
        quality_new = float(st.text_input('quality_new'))
        features_new = float(st.text_input('features_new'))
        brand_value_new = float(st.text_input('brand_value_new'))
        availability_new = float(st.text_input('availability_new'))
        value_new = float(st.text_input('value_new'))
        brand_promotions_new = float(st.text_input('brand_promotions_new'))
        experience_new = float(st.text_input('experience_new'))
        duration_new = float(st.text_input('duration_new'))
        seen_advertisements_new = float(st.text_input('seen_advertisements_new'))
